...
public class TileEntityAdvancedBrewingStand extends TileEntity implements IInventory, ITickable
{
	...
	{
		return this.hasCustomName() ? this.customName : "container.advanced_brewing_stand";
	}
	...
	public void update() 
	{
		...
		if(!this.world.isRemote) 
		{
			...
			{
				flag1 = true;
				AdvancedBrewingStand.setState(this.isBurning(), this.world, this.pos);
			}
		} 
	...
	private boolean canSmelt() 
	{
		...
		{
			ItemStack result = AdvancedBrewingStandRecipes.getInstance().getABSResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));	
	...
	public void smeltItem() 
	{
		if(this.canSmelt()) 
		{
			...
			ItemStack result = AdvancedBrewingStandRecipes.getInstance().getABSResult(input1, input2);
			ItemStack output = (ItemStack)this.inventory.get(3);
	...
	public static int getItemBurnTime(ItemStack fuel) 
	{
		...
		else 
		{
			...
			if (item == ModItems.SPICY_ONIT_FUEL) return 3200;
